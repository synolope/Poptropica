(async function(){
  ...
  "referrerPolicy": "strict-origin-when-cross-origin",
  "body": "login=" + username + "&pass_hash=" + md5(password) + "&dbid=1&look=1%2C14579530%2C2825497%2C2829366%2C100%2C1%2C1%2Cjuly_surfer%2C4%2Cgotgame%2Cjuly_surfer%2Ctyson%2C1%2C1%2C1%2C1%2C1%2Cnone%3A",
  "method": "POST",
  "mode": "cors",
  "credentials": "include"
});
